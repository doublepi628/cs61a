...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            elif self.is_container == True and self.can_contain(place.ant):
    ...
    def double(self):
        ...
        if self.doubled == False:
            self.damage *= 2
            self.doubled = True
        if self.is_container == True and self.ant_contained != None and self.ant_contained.doubled == False:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        p0 = self.place
        length = 0
        while (len(p0.bees) == 0 or length < self.lower_bound or length > self.upper_bound) and p0.is_hive == False :
            p0 = p0.entrance
            length += 1
        if p0.is_hive == False:
...
class LaserAnt(ThrowerAnt):
    ...
    def insects_in_front(self):
        ...
        for b in place.bees:
            dic[b] = dist
        while place.entrance.is_hive == False:
            dist += 1
